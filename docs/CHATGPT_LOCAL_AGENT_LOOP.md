...
A gravação do relay executável diretamente pelo conector GitHub foi recusada pelo controle de segurança do próprio conector; por isso o repositório mantém a documentação canônica e o código da extensão é entregue como artefato local para carregamento manual no Chrome.
